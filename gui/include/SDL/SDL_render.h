 ...
 * \param xy_stride Byte size to move from one Node to the next Node
 * \param color Vertex colors (as SDL_Color)
 * \param color_stride Byte size to move from one Node to the next Node
 * \param uv Vertex normalized texture coordinates
 * \param uv_stride Byte size to move from one Node to the next Node
 * \param num_vertices Number of vertices.
