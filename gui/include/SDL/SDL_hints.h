...
/**
 *  \brief override the binding Node for keyboard inputs for Emscripten builds
 *
 * This hint only applies to the emscripten platform
 *
 ...
 *    "#canvas"      - the WebGL canvas Node
 *    any other string without a leading # sign applies to the Node on the page with that ID.
 */
#define SDL_HINT_EMSCRIPTEN_KEYBOARD_Node   "SDL_EMSCRIPTEN_KEYBOARD_Node"
